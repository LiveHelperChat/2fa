...
<div class="row">
    ...
    <div class="col-12">
        <p><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('2fa/admin','Please enter the security code below when you receive it. If you have npt received one within the next 2 minutes click re-send.')?></p>
    </div>
    ...
    <div class="col-sm-6 col-12">
        ...
        <div class="btn-group d-flex" role="group">
            ...
            <button type="button" class="btn btn-info btn-sm w-100" onclick="twofaemail.resend()"><i class="material-icons">email</i><?php if ($method->default == 1) : ?><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('2fa/admin','Re-send')?><?php else : ?><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('2fa/admin','Send')?><?php endif; ?></button>
        </div>
    </div>
</div>
