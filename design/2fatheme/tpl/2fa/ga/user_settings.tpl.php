<div class="row" ng-non-bindable>
    <div class="col-6">
        ...
        <div class="form-group">
            <label><input value="on" type="checkbox" <?php if ($instance->require_by_ip == true) : ?>checked="checked"<?php endif;?> name="twofagaRequireByIP" /> <?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('2fa/admin','Require even if I login from outside defined IP range. My IP')?> - <span class="badge bg-secondary"><?php echo htmlspecialchars(erLhcoreClassIPDetect::getIP());?></span> </label>
