...
<ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="nav-item"><a class="active nav-link" href="#twofa-sms" aria-controls="twofa-sms" role="tab" data-bs-toggle="tab" ><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('user/account','SMS');?></a></li>
    <li role="presentation" class="nav-item"><a class="nav-link" href="#twofa-email" aria-controls="twofa-email" role="tab" data-bs-toggle="tab" ><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('user/account','Email');?></a></li>
    <li role="presentation" class="nav-item"><a class="nav-link" href="#twofa-ga" aria-controls="twofa-ga" role="tab" data-bs-toggle="tab" ><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('user/account','Google Authenticator');?></a></li>
</ul>
